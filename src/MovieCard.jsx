...
function MovieCard(props) {
  ...
  const loadDetails = async() => {
    ...
    const options = {
      ...
      headers: {
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIwMzJmMGNiOWYwMDE4NTM3YWUyNjI0NTJjMzNjMjZiMiIsIm5iZiI6MTc0OTQ5NjA5Ni44NzY5OTk5LCJzdWIiOiI2ODQ3MzEyMDk1YTFjNzdkZWI5MTAzOTgiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.Gd3be5eU2kGRjWC48uOQS2Ua4qRuEiO_X774qop1tDQ'
      }
    };
  ...
  return (
    <div onClick={turnModalOn} style={{marginTop:"10px", borderRadius:"5px", width:"19%", border:"solid 2px black"}}>
        <img alt="Movie Poster" style={{marginTop:"10px", width:"60%"}} src={image}></img>
        <h3 style={{fontSize:"2vw"}} className="movieTitle">{props.title}</h3>
      ...
      { showModal && (
        <div id="playListModal" className="modal">
            <div className="modal-content" style={{ width: "50%"}}>
                <h2>{props.title}</h2>
                <img alt="movie Background Image" width={"400px"} src={backDropImage}></img>
